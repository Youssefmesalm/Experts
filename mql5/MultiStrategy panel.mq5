...
input TRADE_MODE TRADE_TYPE = SINGLE:
input ORDER_TYPE type = BOTH;
input SL_TP sltype = sl_pips;
...
input SL_TP sltype = Supertrend; // SL Type
...
int OnInit() {
  ...
  for(int i = 0; i < ArraySize(aSymbols); i++) {
    ...
    Pendings[i] = new COrder(sym, magic_Number, GROUP_ORDERS_ALL);
    BuyPendings[i] = new COrder(sym, magic_Number, GROUP_ORDERS_BUY_STOP);
    SellPendings[i] = new COrder(sym, magic_Number, GROUP_ORDERS_SELL_STOP);
...
void ObjectsCreateAll() {
  ...
  //---
  color soundclr = SoundIsEnabled?C'59,
  41,
  40': clrNONE;
  //---
  ...
  //---
  color alarmclr = AlarmIsEnabled?clrNONE: C'59,
  41,
  40';
  //---
  ...
  LabelCreate(0, OBJPREFIX+"bb-w", 0, _x1+Dpi(600), _y1+Dpi(30), CORNER_LEFT_UPPER, "BB-W", "Arial Black", 10, COLOR_FONT, 0, ANCHOR_LEFT, false, false, true, 0, "\n");
  LabelCreate(0, OBJPREFIX+"ichi", 0, _x1+Dpi(650), _y1+Dpi(30), CORNER_LEFT_UPPER, "ICHI", "Arial Black", 10, COLOR_FONT, 0, ANCHOR_LEFT, false, false, true, 0, "\n");
  LabelCreate(0, OBJPREFIX+"str", 0, _x1+Dpi(700), _y1+Dpi(30), CORNER_LEFT_UPPER, "STR", "Arial Black", 10, COLOR_FONT, 0, ANCHOR_LEFT, false, false, true, 0, "\n");
  LabelCreate(0, OBJPREFIX+"sar", 0, _x1+Dpi(750), _y1+Dpi(30), CORNER_LEFT_UPPER, "SAR", "Arial Black", 10, COLOR_FONT, 0, ANCHOR_LEFT, false, false, true, 0, "\n");
  LabelCreate(0, OBJPREFIX+"avg", 0, _x1+Dpi(819), _y1+Dpi(30), CORNER_LEFT_UPPER, "AVG", "Arial Black", 10, COLOR_FONT, 0, ANCHOR_LEFT, false, false, true, 0, "\n");
  LabelCreate(0, OBJPREFIX+"trade-pair", 0, _x1+Dpi(870), _y1+Dpi(30), CORNER_LEFT_UPPER, "Tradable pair", "Arial Black", 10, COLOR_FONT, 0, ANCHOR_LEFT, false, false, true, 0, "\n");
  LabelCreate(0, OBJPREFIX+"sl", 0, _x1+Dpi(980), _y1+Dpi(30), CORNER_LEFT_UPPER, "Stoploss", "Arial Black", 10, COLOR_FONT, 0, ANCHOR_LEFT, false, false, true, 0, "\n");
...
void CreateSymbGUI(int i, int Y) {
  ...
  if(sig_BBw(i) == 1) {
    if(useBBw)
    countb++;
    LabelCreate(0, OBJPREFIX+"bb-w"+" - "+_Symb, 0, _x1+Dpi(625), Y, CORNER_LEFT_UPPER, "5", "Webdings", 15, clrLimeGreen, 0, ANCHOR_RIGHT, false, false, true, 0, "Buy "+_Symb);
  ...
  if(sig_BBw(i) == -1) {
    if(useBBw)
    counts++;
    LabelCreate(0, OBJPREFIX+"bb-w"+" - "+_Symb, 0, _x1+Dpi(625), Y, CORNER_LEFT_UPPER, "6", "Webdings", 15, clrRed, 0, ANCHOR_RIGHT, false, false, true, 0, "Sell "+_Symb);
  ...
  else
  {
    if(useBBw)
    countf++;
    LabelCreate(0, OBJPREFIX+"bb-w"+" - "+_Symb, 0, _x1+Dpi(625), Y, CORNER_LEFT_UPPER, "4", "Webdings", 15, clrYellow, 0, ANCHOR_RIGHT, false, false, true, 0, "No Signal "+_Symb);
  ...
  if(sig_ICHI(i) == 1) {
    if(useIchi)
    countb++;
    LabelCreate(0, OBJPREFIX+"ichi"+" - "+_Symb, 0, _x1+Dpi(675), Y, CORNER_LEFT_UPPER, "5", "Webdings", 15, clrLimeGreen, 0, ANCHOR_RIGHT, false, false, true, 0, "Buy "+_Symb);
  ...
  if(sig_ICHI(i) == -1) {
    if(useIchi)
    counts++;
    LabelCreate(0, OBJPREFIX+"ichi"+" - "+_Symb, 0, _x1+Dpi(675), Y, CORNER_LEFT_UPPER, "6", "Webdings", 15, clrRed, 0, ANCHOR_RIGHT, false, false, true, 0, "Sell "+_Symb);
  ...
  else
  {
    if(useIchi)
    countf++;
    LabelCreate(0, OBJPREFIX+"ichi"+" - "+_Symb, 0, _x1+Dpi(675), Y, CORNER_LEFT_UPPER, "4", "Webdings", 15, clrYellow, 0, ANCHOR_RIGHT, false, false, true, 0, "No Signal "+_Symb);
  ...
  if(sig_Supertrend(i) == 1) {
    if(useSuperTrend)
    countb++;
    LabelCreate(0, OBJPREFIX+"str"+" - "+_Symb, 0, _x1+Dpi(725), Y, CORNER_LEFT_UPPER, "5", "Webdings", 15, clrLimeGreen, 0, ANCHOR_RIGHT, false, false, true, 0, "Buy "+_Symb);
  ...
  if(sig_Supertrend(i) == -1) {
    if(useSuperTrend)
    counts++;
    LabelCreate(0, OBJPREFIX+"str"+" - "+_Symb, 0, _x1+Dpi(725), Y, CORNER_LEFT_UPPER, "6", "Webdings", 15, clrRed, 0, ANCHOR_RIGHT, false, false, true, 0, "Sell "+_Symb);
  ...
  else
  {
    if(useSuperTrend)
    countf++;
    LabelCreate(0, OBJPREFIX+"str"+" - "+_Symb, 0, _x1+Dpi(725), Y, CORNER_LEFT_UPPER, "4", "Webdings", 15, clrYellow, 0, ANCHOR_RIGHT, false, false, true, 0, "No Signal "+_Symb);
  }
  ...
  if(sig_SAR(i) == 1) {
    if(useSAR)
    countb++;
    LabelCreate(0, OBJPREFIX+"sar"+" - "+_Symb, 0, _x1+Dpi(775), Y, CORNER_LEFT_UPPER, "5", "Webdings", 15, clrLimeGreen, 0, ANCHOR_RIGHT, false, false, true, 0, "Buy "+_Symb);
  ...
  if(sig_SAR(i) == -1) {
    if(useSAR)
    counts++;
    LabelCreate(0, OBJPREFIX+"sar"+" - "+_Symb, 0, _x1+Dpi(775), Y, CORNER_LEFT_UPPER, "6", "Webdings", 15, clrRed, 0, ANCHOR_RIGHT, false, false, true, 0, "Sell "+_Symb);
  ...
  else
  {
    if(useSAR)
    countf++;
    LabelCreate(0, OBJPREFIX+"sar"+" - "+_Symb, 0, _x1+Dpi(775), Y, CORNER_LEFT_UPPER, "4", "Webdings", 15, clrYellow, 0, ANCHOR_RIGHT, false, false, true, 0, "No Signal "+_Symb);
  }
  ...
  //--
  if(perc_b > perc_s) {
    LabelCreate(0, OBJPREFIX+"avg"+" - "+_Symb, 0, _x1+Dpi(860), Y, CORNER_LEFT_UPPER, DoubleToString(perc_b, 2)+"%", sFontType, 9, clrLimeGreen, 0, ANCHOR_RIGHT, false, false, true, 0, _Symb+" avg : "+DoubleToString(perc_b, 2)+"%");

  }
  else
  if(perc_b < perc_s) {
    LabelCreate(0, OBJPREFIX+"avg"+" - "+_Symb, 0, _x1+Dpi(860), Y, CORNER_LEFT_UPPER, DoubleToString(perc_s, 2)+"%", sFontType, 9, clrRed, 0, ANCHOR_RIGHT, false, false, true, 0, _Symb+" avg : "+DoubleToString(perc_s, 2)+"%");
  }
  else
  {
    LabelCreate(0, OBJPREFIX+"avg"+" - "+_Symb, 0, _x1+Dpi(860), Y, CORNER_LEFT_UPPER, "______", sFontType, 9, clrYellow, 0, ANCHOR_RIGHT, false, false, true, 0, "\n");
  ...
  if(buy) {
    ...
    double sl = 0;
    if(sltype == 0)
    sl = SymbolInfoDouble(_Symb, SYMBOL_ASK)-sl_pips*SymbolInfoDouble(_Symb, SYMBOL_POINT)*10;
    if(sltype == 1)
    sl = temp[0];
    if(sltype == 2)
    sl = temp1[0];
    LabelCreate(0, OBJPREFIX+"sl"+" - "+_Symb, 0, _x1+Dpi(1030), Y, CORNER_LEFT_UPPER, DoubleToString(sl, (int)SymbolInfoInteger(_Symb, SYMBOL_DIGITS)), sFontType, 9, clrRed, 0, ANCHOR_RIGHT, false, false, true, 0, "\n");
    signal[i] = true;
        ...
        if(type == BOTH || type == SELL_ONLY) {
          if(SellPositions[i].GroupTotal() == 0) {
            if(TRADE_TYPE == SINGLE) {
              trades[i].Position(TYPE_POSITION_SELL, NEWLOT, sl, tp, SLTP_PRICE, 30, comment);
            }
            else
            if(TRADE_TYPE == MULTIPLE) {
              trades[i].Position(TYPE_POSITION_SELL, NEWLOT, sl, tp, SLTP_PRICE, 30, comment);
              if(tp1 > 0) {
                if(tpType == RISK_REWARD) {
...
void CalcLot() {
  ...
  if(LotType == RISK) {
    ...
    Lot = NormalizeDouble((AccountInfoDouble(ACCOUNT_EQUITY)*Risk/1000)/sl, nd);
