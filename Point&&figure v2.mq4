   ...
   for(int i=0; i<Bars(Symbol(),PERIOD_CURRENT); i++)
     {
      ...
      for(int x=0; x<ObjectsTotal(0,0,OBJ_TEXT); x++)
        {
         string Name=ObjectName(0,x);
      ...
      if(BP==1&&PB[1]>PB1[1]&&PB[1]>B[1]&&PB1[1]!=0)
        {
      ...
      if(BP==-1&&PB[0]<PB1[0]&&PB[0]<B[0]&&PB1[0]!=0)
        {
