...
if((Market_Order_Type_5==Open_Buy || Market_Order_Type_5==Open_Sell_Buy))
 ...
 if((count_chart_1(Symbol())>0 || count_chart_2(Symbol())>0 || count_chart_3(Symbol())>0 || count_chart_4(Symbol())>0 || count_chart_5(Symbol())>0)&& mn!=1 )
 {
   Modify();
   mn++;
  }
