   ...
   if(MonFriNoBreak)
   ...
   else
     {
      switch(TimeDayOfWeek(Time[0]))
        {
         case 1:
            InTime=CheckTime(MondayStartTime,MondayEndTime);
            ...
            break;
         case 2:
            InTime=CheckTime(TuesdayStartTime,TuesdayEndTime);
            ...
            break;
         case 3:
            InTime=CheckTime(WednesdayStartTime,WednesdayEndTime);
            ...
            break;
         case 4:
            InTime=CheckTime(ThursdayStartTime,ThursdayEndTime);
            ...
            break;
         case 5:
            InTime=CheckTime(FridayStartTime,FridayEndTime);
