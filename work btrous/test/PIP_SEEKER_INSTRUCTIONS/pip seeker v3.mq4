...
extern string   StrategyS1_Settings   = "------< Strategy S1_Settings >------";
input bool Strategy_S1=true;
extern string   StrategyS2_Settings   = "------< Strategy S2_Settings >------";
input bool Strategy_S2=True;
input int TackeProfit_S2=5;
extern string   StrategyS3_Settings   = "------< Strategy S3_Settings >------";
...
//---
   ...
   double spread = MarketInfo(Symbol(),MODE_SPREAD)/10; //Spread

   if(Lasttime1!=Time[0]) //Alerts
     {
   ...
   if(Strategy_S1==true) //Strategy_S1
     {
   ...
   if(Strategy_S2==true) //Strategy_S2
     {
   ...
   if(Strategy_S3==True) //Strategy_S3
     {
