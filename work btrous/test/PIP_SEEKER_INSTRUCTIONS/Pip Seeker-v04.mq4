...
extern string   Strategy_S1_Settings   = "------< Strategy_S1_Settings >------";
input bool Strategy_S1=true;
input int TakeProfit=0;
input int StopLoss=0;
extern string   Strategy_S2_Settings   = "------< Strategy_S2_Settings >------";
input bool Strategy_S2=True;
input int TackeProfit_S2=5;
extern string   Strategy_S23Settings   = "------< Strategy_S3_Settings >------";
input bool Strategy_S3=True;
input int TackeProfit_S3=5;
...
//---
   ...
   double sto_0=  iStochastic(Symbol(),STO_Time1,K_Period1,D_Period1,Slowing1,Stochastic_Method1, Stochastic_price1,0,0);
   ...
   if(Strategy_S2==true)
     {
      if(sto_segnal<STO_Value2 &&((sto>STO_Value3 && sto_2<STO_Value3)||(sto<STO_Value3 && sto_2>STO_Value3)) &&sto< STO_Value4)
        {
      ...
      if(sto_segnal>STO_Value1 &&((sto<STO_Value3 && sto_2>STO_Value3)||(sto>STO_Value3 && sto_2<STO_Value3))  &&sto> STO_Value5)
        {
         if(Lasttradetime1!=Time[0])
           {
   ...
   if(Strategy_S3==True)
     {
      if(sto>STO_Value3 && sto_2>STO_Value3 && sto_0>STO_Value3 &&sto2>STO_Value3 &&sto2_2< STO_Value3)
        {
           {
